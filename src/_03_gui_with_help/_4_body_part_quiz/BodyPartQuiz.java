...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String arnold = JOptionPane.showInputDialog("who is this?");

		// 5. Check their answer. If they guessed correctly:
		// -- Tell them they are right and increase the score by 1
		if (arnold.equalsIgnoreCase("arnold")) {
			score = score + 10;
			showNextImage();
			...
			if (leonardo.equalsIgnoreCase("leonardo")) {
				...
				if (morgan.equalsIgnoreCase("morgan")) {
					score = score + 10;
					showNextImage();
					String jack = JOptionPane.showInputDialog("who is this?");
					if (jack.equalsIgnoreCase("jack")) {
						score = score + 10;
						showNextImage();
					} else {
						JOptionPane.showMessageDialog(null,"WRONG. you dumb bulk box, this Jack");
					}	
				} else {
					JOptionPane.showMessageDialog(null,"WRONG. you dumb bulk box, this Morgan");
				}
			} else {
				JOptionPane.showMessageDialog(null, "WRONG. you dumb bulk box, this Leonardo");
			}
		} else {
			JOptionPane.showMessageDialog(null,"WRONG. you dumb bulk box, this Arnold");
		}
		...
		JOptionPane.showMessageDialog(null,"your overall score is "+ score+".. thats... actually pretty sad");
